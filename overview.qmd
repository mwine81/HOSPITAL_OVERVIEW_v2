...
state_data = pl.read_parquet('data\state_check.parquet').rename(rename_dict)
hospital_data = pl.scan_parquet('data/hospital.parquet')
ndc_data = pl.scan_parquet('data/ndc_names.parquet')
hcpcs_desc = pl.scan_parquet('data/hcpcs_desc.parquet')
```
